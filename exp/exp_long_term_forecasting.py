...
from utils.losses import mse_mae_loss, mape_loss, mase_loss, smape_loss
...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def _select_criterion(self):
        if self.args.loss == 'MAPE':
            ...
            return mse_mae_loss(self.mse_weight)
    ...
    def train(self, setting):
        ...
        self.model.load_state_dict(torch.load(best_model_path, self.args.device))
    ...
    def test(self, setting, test=0):
        ...
        stamp_folder_path = folder_path + f'{stamp}/'
        if not os.path.exists(stamp_folder_path):
            os.makedirs(stamp_folder_path)
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(test_loader):
                ...
                if i % 50 == 0:
                    ...
                    fname = os.path.join(stamp_folder_path, f'{i}.pdf')
                    visual(gt, pd, fname)
        ...
        if self.args.data == 'PEMS':
            print('mse:{}, mape:{}, rmse:{}'.format(mse, mape, rmse))
            f.write('mse:{}, mape:{}, rmse:{}'.format(mse, mape, rmse) + "\n")
